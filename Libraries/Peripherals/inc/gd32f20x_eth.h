 ...
 * Add code for RT-Thread, see line 1428.
 */
 
/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __GD32F20X_ETH_H
#define __GD32F20X_ETH_H
...
/** @defgroup PHY_Reset_Delay 
  * @{
  */ 
#define PHY_RESETDELAY                                  ((uint32_t)0x000FFFFF) //((uint32_t)0x000FFFFF) 
...
extern void     rt_hw_gd32_eth_init (void);
extern void     rt_register_eth_dev (uint8_t mac[6]);
