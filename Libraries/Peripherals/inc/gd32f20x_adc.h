...
#ifndef __GD32F20X_ADC_H
#define __GD32F20X_ADC_H
...
#define ADC_RESOLUTION_10B                           ((uint32_t)0x00001000)
#define ADC_RESOLUTION_8B                            ((uint32_t)0x00002000)
#define ADC_RESOLUTION_6B                            ((uint32_t)0x00003000)
...
/** @defgroup ADC_Oversampling_shift_definition
  * @{
  */
#define ADC_OVERSAMPLING_SHIFT_NONE                  ((uint32_t)0x00000000)
#define ADC_OVERSAMPLING_SHIFT_1B                    ((uint32_t)0x00000020)
#define ADC_OVERSAMPLING_SHIFT_2B                    ((uint32_t)0x00000040)
#define ADC_OVERSAMPLING_SHIFT_3B                    ((uint32_t)0x00000060)
#define ADC_OVERSAMPLING_SHIFT_4B                    ((uint32_t)0x00000080)
#define ADC_OVERSAMPLING_SHIFT_5B                    ((uint32_t)0x000000A0)
#define ADC_OVERSAMPLING_SHIFT_6B                    ((uint32_t)0x000000C0)
#define ADC_OVERSAMPLING_SHIFT_7B                    ((uint32_t)0x000000E0)
#define ADC_OVERSAMPLING_SHIFT_8B                    ((uint32_t)0x00000100)
...
/** @defgroup ADC_Oversampling_ratio_definition
  * @{
  */
#define ADC_OVERSAMPLING_RATIO_2X                    ((uint32_t)0x00000000)
#define ADC_OVERSAMPLING_RATIO_4X                    ((uint32_t)0x00000004)
#define ADC_OVERSAMPLING_RATIO_8X                    ((uint32_t)0x00000008)
#define ADC_OVERSAMPLING_RATIO_16X                   ((uint32_t)0x0000000C)
#define ADC_OVERSAMPLING_RATIO_32X                   ((uint32_t)0x00000010)
#define ADC_OVERSAMPLING_RATIO_64X                   ((uint32_t)0x00000014)
#define ADC_OVERSAMPLING_RATIO_128X                  ((uint32_t)0x00000018)
#define ADC_OVERSAMPLING_RATIO_256X                  ((uint32_t)0x0000001C)
...
void ADC_Resolution_Config(ADC_TypeDef* ADCx, uint32_t ADC_Resolution);
void ADC_OversamplingShift_Config(ADC_TypeDef* ADCx, uint32_t ADC_Oversampling_Shift);
void ADC_OversamplingRatio_Config(ADC_TypeDef* ADCx, uint32_t ADC_Oversampling_Ratio);
